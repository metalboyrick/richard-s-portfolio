...
import projWalletX from "./assets/proj-walletx.png";

import type { LinkIcon } from "./types";

export const PROJECTS = [
  {
    coverImg: projWalletX,
    coverAlt: "WalletX",
    title: <span>WalletX</span>,
    description: (
      <span>
        Modularized account abstracted wallet, providing customized user
        experience based on users' needs. I contributed code to the wallet
        chrome extension as well as the factory deployer UI.
      </span>
    ),
    URLs: [
      {
        icon: "github" as LinkIcon,
        URL: "https://github.com/scale-eth-team-x/",
      },
      {
        icon: "figma" as LinkIcon,
        URL: "https://www.figma.com/file/Dp2eFkqKoZui8qZXuoqRq2/Scaling-Eth-Mockup?node-id=0%3A1&t=eSmBmpo6uxPY9lOs-1",
      },
      {
        icon: "link" as LinkIcon,
        URL: "https://ethglobal.com/showcase/walletx-ufxfy",
      },
    ],
  },
  {
    ...
    description: (
      <span>
        Built the frontend for Droppin Protocol. Droppin protocol provides an
        engagement layer to help track and gain insights from high quality
        engagement. Built with Next.js, React.js. This app is built on top of
        the Polygon network.
      </span>
    ),
    URLs: [
  ...
  },
  {
    ...
    description: (
      <span>
        Built a simple installable web anime browser using Next.js, with the
        AniList GraphQL API as the back end. The app works on both desktop and
        mobile.
      </span>
    ),
    URLs: [
  ...
  },
  {
    ...
    description: (
      <span>
        An application for handling second hand transactions for Indonesian
        University Students using Android SDK and Firebase.
      </span>
    ),
    URLs: [
      {
  ...
  },
  {
    ...
    description: (
      <span>
        Developed a simple 3D graphics renderer with C++ and OpenGL that can
        display 3D models with variable lighting and position, as well as
        movable camera.
      </span>
    ),
    URLs: [
  ...
  },
  {
    ...
    description: (
      <span>
        Implemented a web-based 2D Clicker game. This project was an entry for
  ...
  },
  {
    ...
    description: (
      <span>
        Implemented a 2D Puzzle game with Godot Engine. This project was an
        entry for Godot Wild Jam. Ranked #2 in terms of fun.
      </span>
    ),
    URLs: [
      {
